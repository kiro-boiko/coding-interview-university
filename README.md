...
- [x] **Learn C++**
    ...
    - [x] Intro to Algorithms and Maps
...
- ### Stack
    ...
    - [x] Implemented using linked lists (see Linked Lists: Practice Problems). Implementing with array is trivial
...
- ### Binary search
    ...
    - [ ] [TopCoder Exercises](https://www.topcoder.com/community/competitive-programming/tutorials/binary-search/)
...
- ### Recursion
    ...
    - How is tail recursion better than not?
        ...
        - [ ] [Tail Recursion (video)](https://www.youtube.com/watch?v=_JtPhF8MshA&ab_channel=Computerphile)
